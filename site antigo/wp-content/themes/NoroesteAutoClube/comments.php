...
<?php if ( comments_open() ) : ?>
	<a href="#postcomment" title="<?php _e("Leave a comment"); ?>">Desejo Comentar!</a>
<?php endif; ?>
</h2>
...
<p>
<label for="comment"><small>Seu Comentário:</small></label>
<textarea name="comment" id="comment" cols="58" rows="10" tabindex="4"></textarea>
</p>

<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e('Submit Comment'); ?>" class="btn" />

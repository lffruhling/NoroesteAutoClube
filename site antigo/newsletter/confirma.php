...
<title>Confirmar Noroeste Auto Clube</title>
...
if ($confirma >= '1'){
	$erro = "<h1 style=\"text-align:center; color:#369; padding:10px; font-variant:small-caps;\">
		...
		<br />
        <br /> 
        Obrigado por se cadastrar em nosso boletim. a equipe <strong>Noroeste Auto Clube agradece!</strong>
		<br />
        <br />
        Enviado em: $data
        ...
        $para = 'noroesteautoclube@outlook.com';
...
?>
<?php echo $erro; ?>
<h2 style="color:#F60; font-variant:small-caps; text-align:center;">Noroeste Auto Clube - Todos os Direitos Reservados!</h2>
<div style="text-align:center;">
<a href="http://www.noroesteautoclube.com.br" style="color:#DC0000; font-variant:small-caps;">VOLTE AO SITE!</a>
</span>
</body>
</html>
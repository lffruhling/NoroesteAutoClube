  ...
  if(empty($email)){
   ...
   echo "Cadastro com sucesso! confirme em seu email";
	 ...
	 $msn = "
		...
		<br />
        <br />
		<a href=\"http://www.noroesteautoclube.com.br/newsletter/confirma.php?email=$email&amp;codigo=$codigo\">Confirmar Cadastro</a>
		<br />
        <br />
        Se você não cadastrou este pedido em nosso site, por favor ignore este email!
		<br />
		Atenciosamente <strong>Noroeste Auto Clube</strong>
		<br />
        <br />
        Enviado em: $data
	 ";
	 ...
	 $para = 'noroesteautoclube@outlook.com';
	 $assunto = 'Noroeste Auto Clube - Nova Assinatura de boletim';
	 $data = date('d/m/Y H:i');
